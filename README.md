# Проект по автоматизации тестовых сценариев для проекта <a href="https://https://deeray.com/"><img width="%" title="Deeray.com" src="media/Screen/logo.png" alt="Deeray.com"></a>
